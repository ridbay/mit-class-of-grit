...
// --- Types ---
type Page = 'home' | 'categories' | 'vote' | 'gallery' | 'feedback' | 'payment' | 'nominate';
...
// --- Mock Data ---
const CATEGORIES = ['Best Student', 'Best Project', 'Most Innovative', 'Most Creative', 'Best Leader', 'Social Media Star'];
...
const NOMINEES: Nominee[] = [
  { id: '1', name: 'Alex Johnson', category: 'Best Student', image: 'https://picsum.photos/seed/student1/400/400' },
  { id: '2', name: 'Sarah Williams', category: 'Best Student', image: 'https://picsum.photos/seed/student2/400/400' },
  { id: '3', name: 'David Chen', category: 'Best Project', image: 'https://picsum.photos/seed/project1/400/400' },
  { id: '4', name: 'Emily Brown', category: 'Best Project', image: 'https://picsum.photos/seed/project2/400/400' },
  { id: '5', name: 'Michael Scott', category: 'Most Innovative', image: 'https://picsum.photos/seed/innov1/400/400' },
  { id: '6', name: 'Pam Beesly', category: 'Most Innovative', image: 'https://picsum.photos/seed/innov2/400/400' },
];

const TESTIMONIALS: Testimonial[] = [
  { id: '1', name: 'John Doe', quote: "The awards night was the highlight of my final year. Seeing everyone's hard work recognized was truly inspiring.", rating: 5, image: 'https://picsum.photos/seed/user1/100/100' },
  { id: '2', name: 'Jane Smith', quote: "A night of elegance and celebration. The department really knows how to put on a show!", rating: 5, image: 'https://picsum.photos/seed/user2/100/100' },
  { id: '3', name: 'Robert Lee', quote: "I'm so excited for this year's event. The voting process is fair and the atmosphere is electric.", rating: 4, image: 'https://picsum.photos/seed/user3/100/100' },
  { id: '4', name: 'Alice Wong', quote: "Incredible organization and a truly professional academic atmosphere. Highly recommended!", rating: 5, image: 'https://picsum.photos/seed/user4/100/100' },
];

const GALLERY_ITEMS: GalleryItem[] = [
  { id: '1', type: 'photo', url: 'https://picsum.photos/seed/event1/800/600', thumbnail: 'https://picsum.photos/seed/event1/400/300', caption: 'Grand Opening Ceremony 2025', category: 'Photos' },
  { id: '2', type: 'photo', url: 'https://picsum.photos/seed/event2/800/600', thumbnail: 'https://picsum.photos/seed/event2/400/300', caption: 'Award Presentation', category: 'Photos' },
  { id: '3', type: 'video', url: '#', thumbnail: 'https://picsum.photos/seed/video1/400/300', caption: '2025 Highlights Reel', category: 'Videos' },
  { id: '4', type: 'photo', url: 'https://picsum.photos/seed/event3/800/600', thumbnail: 'https://picsum.photos/seed/event3/400/300', caption: 'Student Innovation Showcase', category: 'Highlights' },
  { id: '5', type: 'photo', url: 'https://picsum.photos/seed/event4/800/600', thumbnail: 'https://picsum.photos/seed/event4/400/300', caption: 'Networking Dinner', category: 'Photos' },
  { id: '6', type: 'video', url: '#', thumbnail: 'https://picsum.photos/seed/video2/400/300', caption: 'Keynote Speech Highlights', category: 'Videos' },
];

const HERO_SLIDES = [
  { image: 'https://images.unsplash.com/photo-1523580494863-6f3031224c94?auto=format&fit=crop&q=80&w=2070', title: 'Celebrating Academic Excellence', subtitle: 'Join us for a night of recognition and achievement.' },
  { image: 'https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&q=80&w=2069', title: 'Innovation at its Finest', subtitle: 'Witness the most groundbreaking projects of the year.' },
  { image: 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?auto=format&fit=crop&q=80&w=2012', title: 'A Community of Grit', subtitle: 'Honoring the masters of IT and their journey.' },
];
...
const FAQS = [
  { q: "How are the winners decided?", a: "Winners are decided through a combination of student voting (60%) and a faculty review panel (40%) to ensure both popularity and academic merit are recognized." },
  { q: "Can I change my vote after submission?", a: "Yes, you can change your selection at any time before the voting deadline by re-identifying yourself and updating your choices." },
  { q: "What is the dress code for the night?", a: "The dress code is Black Tie / Formal. We encourage everyone to dress their best for this prestigious celebration!" },
  { q: "Is there a limit to how many tickets I can buy?", a: "Each student is eligible for up to 2 tickets (one for themselves and one for a guest). Tickets are limited and sold on a first-come, first-served basis." },
];
    ...
    <div className="flex gap-4 md:gap-8 justify-center">
      {Object.entries(timeLeft).map(([label, value]) => (
        <div key={label} className="flex flex-col items-center">
          ...
          <span className="mt-2 text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] text-white/70">{label}</span>
        </div>
      ))}
    </div>
  );
...
const SponsorsSection = () => (
  <section className="py-20 overflow-hidden bg-slate-50 dark:bg-slate-900/50 border-y border-slate-100 dark:border-slate-800">
    <div className="max-w-7xl mx-auto px-6 mb-12 text-center">
      <h4 className="text-xs font-black uppercase tracking-[0.3em] text-slate-400 mb-4">Our Prestigious Partners</h4>
    </div>
    <div className="flex gap-12 animate-marquee whitespace-nowrap">
      {[...SPONSORS, ...SPONSORS].map((s, i) => (
        <div key={i} className="flex items-center gap-4 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer">
          ...
          <span className="text-xl font-black text-slate-400 dark:text-slate-600">{s.name}</span>
        </div>
      ))}
    </div>
  </section>
    ...
    <section className="py-24 px-6 max-w-7xl mx-auto">
      <div className="glass-card overflow-hidden flex flex-col lg:flex-row items-center">
        ...
        <div className="lg:w-1/2 p-12 lg:p-20">
          <span className="text-xs font-black text-brand-blue uppercase tracking-[0.2em] mb-4 block">Featured Student</span>
          ...
          <p className="text-xl text-slate-500 dark:text-slate-400 mb-10 leading-relaxed italic">
            "Innovation isn't just about the code; it's about the grit we show when the code fails. I'm honored to be nominated for {spotlight.category}."
          </p>
          <div className="flex items-center gap-4 p-6 bg-slate-50 dark:bg-slate-800/50 rounded-3xl border border-slate-100 dark:border-slate-700">
            ...
            <div>
              <h4 className="font-black text-slate-900 dark:text-white">{spotlight.category} Nominee</h4>
              <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Class of 2026</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="py-24 px-6 max-w-4xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-slate-500">Everything you need to know about the Awards Night.</p>
      </div>
...
const ResultsDashboard = ({ globalVotes }: { globalVotes: Record<string, Record<string, number>> }) => {
  const [activeCategory, setActiveCategory] = useState(CATEGORIES[0]);

  const chartData = NOMINEES
  ...
  return (
    <div className="glass-card p-8 border-slate-100 dark:border-slate-800">
      <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-6">
        <div>
          <h4 className="text-xl font-black text-slate-900 dark:text-white mb-2">Live Voting Analytics</h4>
          <p className="text-sm text-slate-400">Real-time distribution of votes across categories.</p>
        </div>
    ...
    <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl overflow-hidden border border-slate-100 dark:border-slate-800">
      <div className="bg-brand-blue p-8 text-white relative overflow-hidden">
        ...
        <div className="flex justify-between items-start mb-8">
          <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-brand-blue font-black text-xl">G</div>
          <span className="text-[10px] font-black uppercase tracking-[0.3em] opacity-60">Official Ticket</span>
        </div>
        <h3 className="text-2xl font-black mb-1">Class of Grit</h3>
        <p className="text-xs font-bold opacity-80 uppercase tracking-widest">Awards Night 2026</p>
      </div>
      ...
      <div className="p-8 space-y-8 relative">
        <div className="flex justify-between gap-4">
          ...
          <div className="text-right">
            ...
            <p className="font-black text-slate-900 dark:text-white">{matric}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="font-bold text-slate-700 dark:text-slate-300">May 15, 2026</p>
          </div>
          <div>
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Time</p>
            <p className="font-bold text-slate-700 dark:text-slate-300">19:00 PM</p>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-dashed border-slate-200 dark:border-slate-700 flex flex-col items-center">
          ...
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Scan at Entrance</p>
        </div>
      </div>
      
      <div className="bg-slate-50 dark:bg-slate-800/50 p-4 text-center">
        <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">Non-Transferable • Valid for 1 Entry</p>
      </div>
    </div>
...
const IdentificationForm = ({ 
  ...
  <div className="max-w-md mx-auto glass-card p-12 text-center">
    ...
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <button type="submit" className="w-full btn-primary py-4 text-lg shadow-xl shadow-brand-blue/20">
        Proceed
      </button>
    </form>
  </div>
    ...
    <section className="py-24 px-6 min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 max-w-xl mx-auto">Help us identify the stars of our class. You can nominate any student for any category.</p>
            ...
            <div className="glass-card p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {filteredStudents.map(student => {
                  const isNominated = (nominations[selectedCategory] || []).includes(student.id);
                  return (
                    <div 
                      key={student.id}
                      className={`p-6 rounded-3xl border-2 transition-all flex items-center justify-between ${
                        isNominated ? 'border-emerald-500 bg-emerald-50' : 'border-slate-100 bg-white hover:border-brand-blue'
                      }`}
                    >
                      <div>
                        <h4 className="font-bold text-slate-900">{student.name}</h4>
                        <p className="text-xs text-slate-400 font-mono">{student.matric}</p>
                      </div>
                      <button
                      ...
                      >
                        {isNominated ? <CheckCircle2 size={20} /> : <UserPlus size={20} />}
                      </button>
                    </div>
                  );
                })}
...
export default function App() {
  ...
  const [galleryFilter, setGalleryFilter] = useState<'Photos' | 'Videos' | 'Highlights'>('Photos');
  ...
  const [isDarkMode, setIsDarkMode] = useState(() => {
    if (typeof window !== 'undefined') {
      return localStorage.getItem('grit_theme') === 'dark' || 
             (!localStorage.getItem('grit_theme') && window.matchMedia('(prefers-color-scheme: dark)').matches);
    }
    return false;
  });
  ...
  useEffect(() => {
    ...
    if (savedMatric && savedMiddle) {
      ...
      const savedVotes = localStorage.getItem(`grit_votes_${savedMatric}_${savedMiddle}`);
  ...
  const handleVote = (category: string, nomineeId: string) => {
    ...
    setVotes(newVotes);
    localStorage.setItem(`grit_votes_${matricNumber}_${middleName}`, JSON.stringify(newVotes));
  };
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button 
              ...
              className="p-3 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-brand-blue/10 hover:text-brand-blue transition-all"
            >
              {isDarkMode ? <Sun size={20} /> : <Moon size={20} />}
            </button>

            <button onClick={() => navigate('payment')} className="btn-primary py-2 px-6 text-sm">Get Tickets</button>
          </div>
          ...
          {isMenuOpen && (
            ...
            >
              <div className="p-6 flex flex-col gap-4">
                ...
                <button onClick={() => navigate('payment')} className="btn-primary w-full">Get Tickets</button>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
              ...
              <section className="py-24 px-6 bg-slate-50 dark:bg-slate-900/50">
                <div className="max-w-7xl mx-auto">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                      { icon: <Trophy />, title: "Excellence Awards", desc: "Recognizing the top achievers in our department.", target: 'categories' },
                      { icon: <Camera />, title: "Memorable Moments", desc: "Capturing the spirit of our academic journey.", target: 'gallery' },
                      { icon: <Vote />, title: "Your Voice Matters", desc: "Participate in our strict-mode voting system.", target: 'vote' }
                    ].map((item, i) => (
                      <div 
                        key={i} 
          ...
          {currentPage === 'categories' && (
            ...
            >
              <div className="text-center mb-16">
                ...
                <p className="text-slate-500 max-w-xl mx-auto">Discover the prestigious awards we present to our outstanding students and projects.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {CATEGORIES.map((category) => (
                  <div key={category} className="glass-card p-10 text-center group hover:shadow-2xl transition-all">
                    ...
                    <h3 className="text-2xl font-black text-slate-900 mb-4">{category}</h3>
                    <p className="text-slate-500 mb-6">Recognizing excellence and dedication in the field of {category.toLowerCase()}.</p>
                    <button onClick={() => navigate('vote')} className="text-brand-blue font-bold flex items-center gap-2 mx-auto hover:gap-3 transition-all">
          ...
          {currentPage === 'gallery' && (
            ...
            >
              <div className="text-center mb-16">
                ...
                <p className="text-slate-500 max-w-xl mx-auto">Relive the highlights of our past celebrations and academic milestones.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {GALLERY_ITEMS.filter(item => item.category === galleryFilter).map((item) => (
                  <motion.div 
                    layout
                    key={item.id}
                    whileHover={{ 
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-8">
                      ...
                      <div className="absolute top-6 right-6 flex gap-2 opacity-0 translate-y-[-20px] group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-out">
                        {[
                          { icon: <Twitter size={14} />, color: 'bg-sky-500', label: 'Twitter' },
                          { icon: <Facebook size={14} />, color: 'bg-blue-600', label: 'Facebook' },
                          { icon: <Linkedin size={14} />, color: 'bg-blue-700', label: 'LinkedIn' },
                          { icon: <Share2 size={14} />, color: 'bg-slate-700', label: 'Share' }
                        ].map((btn, idx) => (
                          <button 
                            key={idx}
                            onClick={(e) => {
                              ...
                              console.log(`Sharing "${item.caption}" to ${btn.label}`);
                            }}
          ...
          {currentPage === 'feedback' && (
            ...
            >
              <div className="text-center mb-16">
                ...
                <p className="text-slate-500 max-w-xl mx-auto">Hear from our students about their experiences and the impact of the Class of Grit.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {TESTIMONIALS.map((t) => (
                  ...
                  >
                    <img src={t.image} alt={t.name} className="w-24 h-24 rounded-3xl object-cover shadow-lg" referrerPolicy="no-referrer" />
                    <div className="flex-grow text-center md:text-left">
                      <div className="flex justify-center md:justify-start gap-1 mb-4">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} size={16} className={i < t.rating ? "fill-brand-teal text-brand-teal" : "text-slate-200"} />
                        ))}
                      </div>
                      <p className="text-slate-600 italic mb-6 leading-relaxed">"{t.quote}"</p>
                      <h4 className="text-lg font-bold text-slate-900">{t.name}</h4>
                      <p className="text-xs font-bold text-brand-blue uppercase tracking-widest">Verified Student</p>
                    </div>
                  </motion.div>
                ))}
              </div>
          ...
          {currentPage === 'vote' && (
            ...
            >
              <div className="text-center mb-16">
                ...
                <p className="text-slate-500 max-w-xl mx-auto">One vote per category. Your selection is final once submitted.</p>
                  ...
                  <div className="space-y-20">
                    {CATEGORIES.map((category) => (
                      <div key={category}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          {NOMINEES.filter(n => n.category === category).map((nominee) => (
                            <motion.div 
                              layout
                              key={nominee.id}
                              onClick={() => handleVote(category, nominee.id)}
                              whileHover={!votes[category] ? { y: -4, scale: 1.01 } : {}}
                              whileTap={!votes[category] ? { scale: 0.98 } : {}}
                              animate={{
                                scale: votes[category] === nominee.id ? 1.02 : 1,
                                boxShadow: votes[category] === nominee.id ? '0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)' : '0 1px 2px 0 rgb(0 0 0 / 0.05)'
                              }}
                            ...
                            >
                              <div className="flex items-center gap-6">
                                <div className="w-24 h-24 rounded-3xl overflow-hidden shadow-lg relative">
                                  <img src={nominee.image} alt={nominee.name} className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                                  <AnimatePresence>
                                    {votes[category] === nominee.id && (
                                      <motion.div 
                                ...
                                <div className="flex-grow">
                                  <h4 className="text-xl font-bold text-slate-900 mb-1">{nominee.name}</h4>
                                  <p className="text-slate-400 text-sm mb-4">Nominee for {category}</p>
                                  <AnimatePresence mode="wait">
                                    {votes[category] === nominee.id ? (
                                      <motion.div 
                                        key="selected"
                                      ...
                                      >
                                        <span className="text-xs font-black text-brand-blue uppercase tracking-widest">Selected</span>
                                      ...
                                      >
                                        {votes[category] ? 'Change Selection' : 'Cast Vote'} <ChevronRight size={14} />
                                      </motion.button>
                                    )}
                                  </AnimatePresence>
                                </div>
                    ...
                    {isSubmitted ? (
                      <div className="glass-card p-12 max-w-2xl mx-auto border-emerald-100 bg-emerald-50/30">
                        ...
                        <h3 className="text-2xl font-black text-slate-900 mb-2">
                          {ipVoted || deviceVoted ? 'Vote Already Recorded' : 'Votes Submitted!'}
                        </h3>
                        ...
                        <div className="mt-12 text-left max-w-4xl mx-auto">
                          <div className="flex items-center gap-3 mb-8">
                            ...
                            <h4 className="text-xl font-black text-slate-900 dark:text-white">Live Results Analytics</h4>
                          </div>
                        ...
                        {!ipVoted && !deviceVoted && (
                          <button onClick={() => setIsSubmitted(false)} className="mt-12 text-brand-blue font-bold hover:underline block mx-auto">Edit My Votes</button>
                        )}
                      </div>
                    ) : (
                      <>
                        <button 
                          ...
                          disabled={Object.keys(votes).length < CATEGORIES.length}
                          className="btn-primary px-12 py-4 text-lg shadow-xl shadow-brand-blue/20"
                        >
                          Submit Final Votes
                        </button>
                        <p className="mt-4 text-xs text-slate-400 font-medium">
                          {Object.keys(votes).length} of {CATEGORIES.length} categories voted
                        </p>
                      </>
                    )}
                  </div>
                        ...
                        >
                          <div className="p-10">
                            <div className="flex items-center gap-4 mb-8">
                              ...
                              <div>
                                <h3 className="text-2xl font-black text-slate-900">Confirm Your Votes</h3>
                                <p className="text-sm text-slate-400">Review your selections for each category.</p>
                              </div>
                            </div>
                              ...
                              {CATEGORIES.map((cat) => (
                                <div key={cat} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                  ...
                                  <span className="font-bold text-slate-900">
                                    {NOMINEES.find(n => n.id === votes[cat])?.name || 'Not Selected'}
                                  </span>
                                </div>
                              ))}
                            </div>
                              ...
                              <button 
                                onClick={async () => {
                                  try {
                                    ...
                                    const res = await fetch('/api/record-vote', { method: 'POST' });
                                    if (!res.ok) {
                                      const data = await res.json();
                                      setMatricError(data.error || 'Voting failed');
                                    ...
                                    Object.entries(votes).forEach(([cat, nomineeId]) => {
                                      const catData = { ...(updatedGlobal[cat as string] || {}) };
                                      catData[nomineeId as string] = (catData[nomineeId as string] || 0) + 1;
                                      updatedGlobal[cat as string] = catData;
                                    });
                                    setGlobalVotes(updatedGlobal);
                                    localStorage.setItem('grit_global_votes', JSON.stringify(updatedGlobal));
                                    
                                    // Record device vote
                                    localStorage.setItem('grit_has_voted_device', 'true');
                                    setDeviceVoted(true);
                                    ...
                                    setMatricError('Connection error. Please try again.');
                                    setShowVoteModal(false);
                                  }
                                }}
          ...
          {currentPage === 'payment' && (
            ...
            >
              <div className="text-center mb-16">
                ...
                <p className="text-slate-500">Join us for an unforgettable night of celebration.</p>
              </div>
              ...
              <div className="glass-card p-8 md:p-12">
                {paymentStatus === 'success' ? (
                  ...
                  >
                    ...
                    <p className="text-slate-500 mb-12 max-w-md mx-auto">Your ticket has been generated. Please save your digital ticket for entry.</p>
                    
                    <DigitalTicket name={middleName || "Guest"} matric={matricNumber || "N/A"} />
                    
                    <div className="mt-12">
                      <button onClick={() => navigate('home')} className="text-slate-400 font-bold hover:text-brand-blue transition-colors">Return Home</button>
                    </div>
                  </motion.div>
                ) : (
                  <form onSubmit={handlePayment} className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-2">
                        ...
                        <input required type="text" placeholder="John Doe" className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-4 focus:outline-none focus:ring-2 focus:ring-brand-blue/20 transition-all" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-xs font-bold uppercase tracking-widest text-slate-400 flex items-center gap-2">
                          <Mail size={14} /> Email Address
                        </label>
                        <input required type="email" placeholder="john@example.com" className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-4 focus:outline-none focus:ring-2 focus:ring-brand-blue/20 transition-all" />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <input disabled type="text" value="45.00" className="w-full bg-slate-100 border border-slate-100 rounded-2xl px-10 py-4 font-bold text-slate-900" />
                        </div>
                      </div>
                      <div className="space-y-2">
                        <label className="text-xs font-bold uppercase tracking-widest text-slate-400 flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-12 h-12 bg-gradient-to-br from-brand-blue to-brand-teal rounded-xl flex items-center justify-center text-white font-black text-2xl">G</div>
                <div className="flex flex-col items-start leading-none">
                  <span className="font-black text-xl tracking-tighter">CLASS OF <span className="text-brand-teal">GRIT</span></span>
                  <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-white/40">Masters of IT</span>
                </div>
              </div>
              <p className="text-slate-400 max-w-sm mb-10 font-medium leading-relaxed">
                Celebrating the resilience, innovation, and excellence of our department's finest. Join us in honoring the masters of IT.
              </p>
              <div className="flex gap-4">
                {[Instagram, Twitter, Facebook].map((Icon, i) => (
                  <a key={i} href="#" className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-brand-blue hover:border-brand-blue transition-all">
                    <Icon size={20} />
                  </a>
                ))}
              </div>
            ...
            <div>
              ...
              <ul className="space-y-4 font-bold">
                {['Home', 'Gallery', 'Feedback', 'Vote', 'Payment'].map(link => (
                  <li key={link}><button onClick={() => navigate(link.toLowerCase() as Page)} className="hover:text-brand-teal transition-colors">{link}</button></li>
                ))}
              </ul>
            </div>

            <div>
              <h4 className="text-sm font-black uppercase tracking-[0.2em] text-white/40 mb-8">Contact</h4>
              <ul className="space-y-4 font-bold text-slate-400">
                <li className="flex items-center gap-3"><Mail size={18} className="text-brand-teal" /> awards@classofgrit.edu</li>
                <li className="flex items-center gap-3"><MapPin size={18} className="text-brand-teal" /> IT Building, Room 402</li>
              </ul>
            </div>
          </div>
