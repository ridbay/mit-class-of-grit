...
export const SPONSORSHIP_TIERS = [
  {
    ...
    icon: "🥉",
    price: "₦100,000",
    tagline: "Entry-level visibility for brands that want to support MIT Connect 2026.",
    color: "from-[#CD7F32] via-[#B87333] to-[#804A00]",
    benefits: [
      "Logo on event banner and digital flyer",
      "Name listed on sponsor page",
      "1 sponsor appreciation post",
  ...
  },
  {
    ...
    icon: "🥈",
    price: "₦250,000",
    tagline: "Stronger visibility with repeated brand recognition before and during the event.",
    color: "from-[#CBD5E1] via-[#94A3B8] to-[#475569]",
    benefits: [
      "Everything in Bronze",
      "Logo on select printed materials",
      "2 MC mentions during the event",
      "2 promo posts before the event",
  ...
  },
  {
    ...
    icon: "🥇",
    price: "₦500,000",
    tagline: "Meaningful presence for brands that want stronger association with the event.",
    color: "from-[#FDE047] via-[#EAB308] to-[#854D0E]",
    popular: true,
    benefits: [
      "Everything in Silver",
      "Prominent logo on event materials",
      "60-second branded reel during the event",
  ...
  },
  {
    ...
    icon: "💎",
    price: "₦1,000,000",
    tagline: "Premium positioning with deeper audience engagement and on-ground presence.",
    color: "from-[#F8FAFC] via-[#CBD5E1] to-[#64748B]",
    benefits: [
      "Everything in Gold",
      "Official Platinum Sponsor recognition",
      "Branded activation stand or display table",
      "90-second branded reel + 2-minute MC introduction",
      "Weekly promo mentions until the event",
  ...
  },
  {
    ...
    tagline: "The most exclusive partnership tier, handled by direct discussion.",
    color: "from-[#2DD4BF] via-[#14B8A6] to-[#0D9488]",
    exclusive: true,
    benefits: [
      "Everything in Platinum",
      "Exclusive Presenting Partner recognition",
      "Event co-branding rights",
      "Most prominent logo placement",
      "Opening acknowledgement at the event",
      "Premium activation presence",
      "Tailored benefits by private partnership",
    ],
  },
];
