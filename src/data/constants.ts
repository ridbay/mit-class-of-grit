...
export const HERO_SLIDES = [
  {
    ...
    subtitle:
      "A premium technology, innovation, networking, pitch, dinner, and awards experience bringing together postgraduate IT students, alumni, lecturers, university representatives, entrepreneurs, innovators, corporate leaders, and key stakeholders within the technology ecosystem.",
  },
  // {
  //   image: "/banner.jpeg",
...
export const EVENT_DETAILS = {
  ...
  venue: "The Providence Hotel, Ikeja GRA, Lagos",
  organizedBy: [
...
export const SPONSORS = [
  ...
  { name: "Bmoni", logo: "/bmoni_logo.jpg" },
...
export const SPONSORSHIP_TIERS = [
  {
    ...
    icon: "🥉",
    price: "₦100,000",
    tagline: "Best for basic digital visibility",
    color: "from-[#CD7F32] via-[#B87333] to-[#804A00]",
    benefits: [
      "Logo placement on digital event flyer",
      "Brand recognition on sponsor/partner section of the website",
      "Appreciation post on Class of Grit digital platforms",
      "Mention in selected event publicity materials",
      "Thank-you recognition after the event",
    ],
  },
  {
    level: "Silver",
    icon: "🥈",
    price: "₦250,000",
    tagline: "Stronger digital & printed visibility",
    color: "from-[#CBD5E1] via-[#94A3B8] to-[#475569]",
    benefits: [
      "All Bronze Partner benefits",
      "Logo placement on selected printed event materials",
      "Two MC mentions during the event",
      "Two promotional posts before the event",
      "One event access pass",
      "Recognition on the partnership page",
      "Post-event appreciation mention",
    ],
  },
  {
    level: "Gold",
    icon: "🥇",
    price: "₦500,000",
    tagline: "Stronger presence & digital promotion · Most Popular",
    color: "from-[#FDE047] via-[#EAB308] to-[#854D0E]",
    popular: true,
    benefits: [
      "All Silver Partner benefits",
      "More prominent logo placement on event materials",
      "60-second branded promotional reel",
      "Featured brand profile on the website",
      "Two event access passes",
      "Brand mention during major event segments",
      "Recognition in post-event media highlights",
    ],
  },
  {
    level: "Platinum",
    icon: "💎",
    price: "₦1,000,000",
    tagline: "Premium visibility & direct event presence",
    color: "from-[#F8FAFC] via-[#CBD5E1] to-[#64748B]",
    benefits: [
      "All Gold Partner benefits",
      "Official event recognition as a Platinum Partner",
      "Activation stand or branded presence at the event",
      "90-second branded promotional reel",
      "Two-minute MC brand introduction",
      "Weekly promotional mentions before the event",
      "Four event access passes",
  ...
  },
  {
    ...
    tagline: "One Exclusive Slot · Most Exclusive",
    color: "from-[#2DD4BF] via-[#14B8A6] to-[#0D9488]",
    exclusive: true,
    benefits: [
      "All Platinum Partner benefits",
      "Exclusive recognition as Headline Partner",
      '"Presented by" or "In partnership with" visibility, where applicable',
      "Most prominent logo placement across event materials",
      "Co-branding opportunity on selected event assets",
      "Opening acknowledgement during the event",
      "Premium activation space",
      "Special recognition by the planning committee",
      "Featured brand story on the website",
      "Priority visibility in event media and post-event content",
      "Customized partnership benefits based on brand goals",
    ],
  },
];

export const SPECIAL_PARTNERSHIPS = [
  {
    title: "Strategic Innovation Partner",
    desc: "For technology companies, fintechs, innovation hubs, accelerators, software companies, and enterprise brands that want to support the pitch showcase, startup ideas, SaaS products, innovation conversations, or student-led technology projects.",
    benefits: [
      "Naming rights for the pitch showcase",
      "Speaking or panel opportunity",
      "Brand recognition during innovation segments",
      "Logo placement on pitch showcase materials",
      "Opportunity to engage selected innovators or student founders",
      "Custom post-event innovation feature",
    ],
    cta: "Discuss Innovation Partnership",
  },
  {
    title: "Event Hospitality Partner",
    desc: "For brands that want to support the guest experience, dinner, refreshments, or premium event hospitality.",
    benefits: [
      "Recognition as Event Hospitality Partner",
      "Brand mention during dinner/networking segment",
      "Logo placement around hospitality-related materials",
      "Appreciation post after the event",
      "Opportunity for branded guest experience, where suitable",
    ],
    cta: "Support Event Hospitality",
  },
  {
    title: "Awards Partner",
    desc: "For brands that want to support the awards and recognition segment of MIT Connect '26.",
    benefits: [
      "Recognition during the awards segment",
      "Logo placement on awards-related materials",
      "Brand mention before selected award presentations",
      "Opportunity to present selected awards, subject to approval",
      "Post-event appreciation feature",
    ],
    cta: "Partner With the Awards Segment",
  },
  {
    title: "Media Partner",
    desc: "For media platforms, creators, bloggers, campus media, technology media, and publicity partners who want to support visibility and storytelling.",
    benefits: [
      "Recognition as Media Partner",
      "Logo placement on event media assets",
      "Access to event coverage moments",
      "Collaboration on pre-event and post-event content",
      "Social media mentions and appreciation",
    ],
