...
export const AboutPage = () => (
  <section className="py-24 px-6 max-w-7xl mx-auto min-h-screen">
    <div className="text-center mb-20">
      ...
      >
        The Class of Grit Awards Night is an evening dedicated to celebrating
        the brilliant minds, hard work, and unyielding determination of our IT
        students.
      </motion.p>
    </div>
    ...
    >
      <div className="flex-1 space-y-8">
        ...
        <p className="text-slate-600 leading-relaxed font-medium text-lg">
          Since its inception, the Class of Grit has been a testament to what
          students can achieve when they combine technical prowess with pure
          determination. This event brings together students, faculty, alumni,
          and industry leaders to recognize those who have pushed boundaries in
          technology and innovation.
        </p>
        <p className="text-slate-600 leading-relaxed font-medium text-lg">
          Through rigorous coursework, groundbreaking projects, and countless
          sleepless nights, our students have shown what it takes to be true
          Masters of IT. Tonight, we celebrate their journey.
        </p>
      </div>
      <div className="flex-1 w-full relative group">
        ...
        <img
          src="/matric_pix.jpg"
          className="rounded-3xl shadow-2xl object-cover h-96 w-full relative z-10 transition-transform duration-500 group-hover:-translate-y-2 group-hover:-translate-x-2"
          alt="About Event"
    ...
    >
      {[
        { value: "250+", label: "Attendees", color: "text-brand-blue" },
        { value: "16", label: "Award Categories", color: "text-brand-teal" },
        ...
        >
          <h4
            className={`text-6xl font-black ${stat.color} mb-4 group-hover:scale-110 transition-transform duration-500 drop-shadow-md`}
          >
            {stat.value}
          </h4>
