...
// .wrangler/tmp/bundle-tyicVl/checked-fetch.js
...
// .wrangler/tmp/pages-kqfEDw/functionsWorker-0.45459125687995017.mjs
...
var onRequestPost2 = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    if (conditions.length > 0) {
      const existingDeviceLog = await db.select().from(vote_logs).where(conditions.length === 1 ? conditions[0] : or(...conditions)).limit(1);
...
// .wrangler/tmp/bundle-tyicVl/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-tyicVl/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.45459125687995017.js.map
